...
(function (b, d) {
    ...
    function h(a, c) {
        if (g(a))
            for (var f = 0, b = a.length; f < b; f++) {
                ...
                for (f in a)
                    if (a.hasOwnProperty(f) && c.call(a[f], f, a[f]) === !1) break
    }
    ...
    function z(a, c) {
        ...
        h(b, function (a, c) {
            if (u = /^(\d+)\.\.(\d+)$/.exec(c))
                for (var b = parseInt(u[1], 10); b <= parseInt(u[2], 10); b++) f[b.toString()] = !0;
            else f[c] = !0
        });
        return f
    }
        ...
        function k(a, c, f) {
            ...
            if (f.getElementsByClassName) {
                ...
                for (i = d.length; k < i; k++)
                    if (B = d[k], B.nodeType == 1)(c = B.className) && (" " + c + " ").indexOf(a) > -1 && u.push(B)
            }
            return u
        }
    ...
    function Oa(a, c, f) {
        ...
        function k(d,
            ...
            for (var m = d.firstChild, l; m;) {
                ...
                if (h > 0)
                    if (m.nodeType == 1)
                        if (j >= 0 && o <= 0) c && u.appendChild(m.cloneNode(!0)), f && e.push(m);
                        else {
                            var s;
    ...
    function kb(a, c) {
        ...
        if (g > 0)
            for (; B.nextSibling && B.nodeType == 1;) B = B.nextSibling;
        h = a.duplicate();
        ta(h, d);
        ...
        if (g > 0 && B.nodeType ==
            3)
            for (f = B.previousSibling; f && f.nodeType == 3;) e -= f.nodeValue.length, f = f.previousSibling;
        return {
            node: B,
            offset: e
        }
    ...
    function ab(a) {
        for (var c =
            document.getElementsByTagName("head")[0] || (aa ? document.body : document.documentElement), f = document.createElement("link"), b = xb(M(a, "absolute")), d = i('link[rel="stylesheet"]', c), k = 0, e = d.length; k < e; k++)
            if (xb(M(d[k].href, "absolute")) === b) return;
        c.appendChild(f);
        f.href = a;
        f.rel = "stylesheet"
    }
    ...
    function Fa(a, c) {
        if (!a.collapsed) {
            var a = a.cloneRange().up(),
                ...
                b = a.startOffset;
            if (ja || a.isControl())
                if ((f = i(f.childNodes[b])) && f.name == "img" && c(f)) return f
        }
    }
        ...
        if (!(C && b !== "br") && (!pa || !(O < 3 && b !== "p")) && !(Na && O < 9)) {
            ...
            i(f).keyup(function (d) {
                if (!(d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey) && b != "br")
                    ...
                    if (k[d] || ba(f, "formatblock", "<p>"), d = c.cmd.commonAncestor("div")) {
    ...
    function Rb() {
        ...
        i(c).keydown(function (f) {
            if (f.which == 9)
                if (f.preventDefault(), a.afterTab) a.afterTab.call(a, f);
                else {
                    var f = a.cmd,
                        b = f.range;
                    b.shrink();
    ...
    if (!b.KindEditor) {
        ...
        i.basePath = function () {
            for (var a =
                document.getElementsByTagName("script"), c, f = 0, b = a.length; f < b; f++)
                if (c = a[f].src || "", /kindeditor[\w\-\.]*\.js/.test(c)) return c.substring(0, c.lastIndexOf("/") + 1);
            return ""
        }();
        i.options = {
            designMode: !0,
            ...
            items: ["source", "|", "undo", "redo", "|", "preview", "print", "template", "code", "cut", "copy", "paste", "plainpaste", "wordpaste", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "subscript", "superscript", "clearhtml", "quickformat", "selectall", "|", "fullscreen", "/", "formatblock",
                "fontname", "fontsize", "|", "forecolor", "hilitecolor", "bold", "italic", "underline", "strikethrough", "lineheight", "removeformat", "|", "image", "multiimage", "flash", "media", "insertfile", "table", "hr", "emoticons", "map", "pagebreak", "anchor", "link", "unlink", "|", "about"
            ],
        ...
        A(R, {
            ...
            pos: function () {
                var a = this[0],
                    ...
                    f = 0;
                if (a)
                    if (a.getBoundingClientRect) a = a.getBoundingClientRect(), f = ma(this.doc), c = a.left + f.x, f = a.top + f.y;
                    else
                        for (; a;) c += a.offsetLeft, f += a.offsetTop, a = a.offsetParent;
                return {
                    x: ca(c),
                    y: ca(f)
                }
        ...
        A(Z, {
            ...
            commonAncestor: function () {
                ...
                for (var c = a(this.startContainer),
                        b = a(this.endContainer), d = 0, i = c.length, k = b.length, e, g; ++d;)
                    if (e = c[i - d], g = b[k - d], !e || !g || e !== g) break;
                return c[i - d + 1]
            },
        ...
        A(ua, {
            ...
            select: function (a) {
                ...
                if (C) try {
                    h = b.get(!0), h.select()
                } catch (o) {} else j && b.collapse(!1), h = b.get(!0), c.removeAllRanges(), c.addRange(h), k !== document && (b = i(h.endContainer).pos(), g.scrollTo(b.x, b.y));
                g.focus();
                return this
            },
            wrap: function (a) {
                ...
                i(a).scan(function (a) {
                    if (!k && a == e.start) k = !0;
                        ...
                        if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
                            for (var g;
                                (g = c.parent()) && g.isStyle() && g.children().length == 1;) c = g;
                            g = b;
                            g = g.clone(!0);
                            if (c.type == 3) Ta(g).append(c.clone(!1)), c.replaceWith(g);
                            else {
                                for (var a = c, h;
            ...
            val: function (a) {
                ...
                if (a === "forecolor") return (a = this.commonNode({
                    "*": ".color"
                })) && (b = a.css("color")), b = q(b), b === "" && (b = "default"),
                b.toLowerCase();
                if (a === "hilitecolor") return (a = this.commonNode({
                    "*": ".background-color"
                })) && (b = a.css("background-color")), b = q(b), b === "" && (b = "default"), b.toLowerCase();
                return b
            },
            toggle: function (a, c) {
        ...
        A(Za, {
            init: function (a) {
                var c = i(a.button),
                    ...
                    d = a.url || "",
                    e = c.val(),
                    k = a.extraParams || {}, g = c[0].className || "",
                ...
                b = ['<div class="ke-inline-block ' + g + '">', a.target ? "" : '<iframe name="' + h + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">' :
                    '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + h + '" action="' + d + '">', '<span class="ke-button-common">', j.join(""), '<input type="button" class="ke-button-common ke-button" value="' + e + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + b + '" tabindex="-1" />', a.form ? "</div>" : "</form>", "</div>"
                ].join("");
                b = i(b, c.doc);
                c.hide();
                c.before(b);
            ...
            submit: function () {
                ...
                c.bind("load", function () {
                    ...
                    var b = i.iframeDoc(c),
                        ...
                        e = "",
                        k, e = d ? d.innerHTML : b.body.innerHTML,
                        e = t(e);
        ...
        yb("core", function (a) {
            ...
            c.afterCreate(function () {
                if (c.syncType == "form") {
                    for (var d = a(c.srcElement), f = !1; d = d.parent();)
                        if (d.name == "form") {
                            f = !0;
                            break
                        }
...
KindEditor.plugin("baidumap", function (b) {
    ...
    d.clickToolbar("baidumap", function () {
        ...
        var m = ['<div style="padding:10px 20px;"><div class="ke-header"><div class="ke-left">', g.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' +
            g.search + '" />', '</span></div><div class="ke-right">', '<input type="checkbox" id="keInsertDynamicMap" name="insertDynamicMap" value="1" /> <label for="keInsertDynamicMap">' + g.insertDynamicMap + "</label>", '</div><div class="ke-clearfix"></div></div>', '<div class="ke-map" style="width:' + l + "px;height:" + e + 'px;"></div>', "</div>"
        ].join(""),
            m = d.createDialog({
                name: "baidumap",
                width: l + 42,
            ...
            t, p, q = b('<iframe class="ke-textarea" frameborder="0" src="' + d.pluginsPath + 'baidumap/map.html" style="width:' + l + "px;height:" + e + 'px;"></iframe>');
        ...
        var v = ['<div style="padding:20px;"><div class="tabs"></div><div class="tab1" style="display:none;"><div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' +
            ...
            U = d.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function () {
                        if (!U.isLoading)
                            if (r && l && J && J.selectedIndex === 1 || !l) W.fileBox.val() == "" ? alert(d.lang("pleaseSelectFile")) : (U.showLoading(d.lang("uploadLoading")), W.submit(), ea.val(""));
                            else {
                                var e = b.trim(N.val()),
                                    g = Q.val(),
                                    h = G.val(),
    ...
    d.plugin.multiImageDialog = function (j) {
        var o = j.clickFn,
            ...
            t = b.swfupload({
                ...
                buttonImageUrl: l + (d.langType == "zh_TW" ? "select-files-zh_TW.png" : "select-files-en.png"),
                buttonWidth: d.langType == "zh_TW" ? 72 : 88,
                buttonHeight: 23,
...
(function () {
    ...
    SWFUpload.prototype.getFlashHTML = function () {
        ...
        var b = this.settings.post_params,
            d = [];
        if (typeof b === "object")
            for (var g in b) b.hasOwnProperty(g) && d.push(encodeURIComponent(g.toString()) + "=" + encodeURIComponent(b[g].toString()));
        return d.join("&amp;")
        ...
        if (b != void 0) {
            for (var e in b.post)
                if (b.post.hasOwnProperty(e)) {
                    l = e;
                    for (var h;
                        (h = d.exec(l)) !== null;) l = l.replace(h[0], String.fromCharCode(parseInt("0x" + h[1], 16)));
                    g[l] = b.post[e]
                }
            b.post = g
        }
...
KindEditor.plugin("quickformat", function (b) {
    ...
    g.clickToolbar("quickformat", function () {
        ...
        for (var e = g.edit.doc, h = g.cmd.range, m = b(e.body).first(), n, j = [], o = [], s = h.createBookmark(!0); m;) {
            ...
            var t = d(m);
            if (!t || t.name != "img")
                if (l[m.name] ? (m.html(m.html().replace(/^(\s|&nbsp;|\u3000)+/ig, "")), m.css("text-indent", "2em")) : o.push(m), !n || l[n.name] || l[m.name] && !l[n.name]) o.length >
                    0 && j.push(o), o = [];
            m = n
        }
                    ...
                    yesBtn: {
                        ...
                        click: function () {
                            var d = o.val(),
                                ...
                                J = b(H[0]).html() || "",
                                W = b(H[1]).html() || "";
                            if (d == 0 || !/^\d+$/.test(d)) alert(e.lang("invalidRows")), o[0].focus();
                            else if (g == 0 || !/^\d+$/.test(g)) alert(e.lang("invalidRows")), l[0].focus();
                            else if (/^\d*$/.test(h))
                                if (/^\d*$/.test(j))
                                    if (/^\d*$/.test(G))
                                        if (/^\d*$/.test(S))
                                            if (/^\d*$/.test(M))
                                                if (v) h !== "" ? v.width(h + n) : v.css("width", ""), v[0].width !== void 0 && v.removeAttr("width"), j !== "" ? v.height(j + E) : v.css("height", ""), v[0].height !== void 0 && v.removeAttr("height"), v.css("background-color", W), v[0].bgColor !==
                                                ...
                                                else alert(e.lang("invalidSpacing")), r[0].focus();
                                                else alert(e.lang("invalidPadding")), D[0].focus();
                                                else alert(e.lang("invalidHeight")), p[0].focus();
                                                else alert(e.lang("invalidWidth")), m[0].focus()
                        }
                    }
                }).div,
