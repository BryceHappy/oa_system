...
<BR><BR>
<input type="button" class='r_4_button' value="管理輸出" onclick="window.location='<?php echo $add_url; ?>';" />｜<input type="button" class='r_button' value="列印" onclick="window.location='<?php echo site_url('common/print_excel'.'/'.$excel_url); ?>';" />
</form>
...
<tbody>
    ...
    <tr id="tr_table_<?php echo $data['id']; ?>">
        ...
        <td><? if ($data['print'] ==1) { echo "<img src=".base_url()."resources/images/print.png>" ; }?></td>
