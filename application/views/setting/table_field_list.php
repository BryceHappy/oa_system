...
<BR><BR>
<input type="button" class='r_button' value="新增" onclick="window.location='<?php echo $add_url; ?>';" />｜<input type="button" class='r_button' value="列印" onclick="window.location='<?php echo site_url('admin/setting/print_excel'.'/'.$excel_url); ?>';" />
</form>
