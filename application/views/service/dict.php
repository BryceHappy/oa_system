...
<BR><BR><input type="button" class='excel_button' value="列印" onclick="window.location='<?php echo site_url('service/dict/print_excel'.'/'.$excel_url); ?>';" />  
</form>
